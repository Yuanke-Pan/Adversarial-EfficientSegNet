...
def analyse_mask(image_dir, mask_dir, series_ids, suffix='.nii.gz'):
    organ_name_list = ['Liver', 'Right Kidney', 'Spleen', 'Pancreas', 'Aorta', 'Inferior Vena Cava', 'Right Adrenal Gland', 'Left Adrenal Gland', 'Gallbladder', 'Esophagus', 'Stomach', 'Duodenum', 'Left kidney']
...
if __name__ == '__main__':
    image_dir = "/data1/T0/FLARE2022/nnUNet_raw/nnUNet_raw_data/Task505_flareFULL/imagesTr/"
    mask_dir = "/data1/T0/FLARE2022/nnUNet_raw/nnUNet_raw_data/Task505_flareFULL/labelsTr/"
    file_path = "./file.txt"
