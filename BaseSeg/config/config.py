...
_C.DATA_LOADER.UNLABEL_DB_FILE = None
...
# semimodel config
_C.SEMI_SUP = CN()
_C.SEMI_SUP.IS_ENABLE = True
_C.SEMI_SUP.MODE = 'Teacher'
_C.SEMI_SUP.BATCH_SIZE = 1
...
_C.TRAINING.OPTIMIZER.L2_PENALTY = 1e-5

# -----------------------------------------------------------------------------
# Saver
# -----------------------------------------------------------------------------
_C.TRAINING.SAVER = CN()
_C.TRAINING.SAVER.SAVER_DIR = '/data3/workspace/output'
...
_C.TRAINING.SCHEDULER.LR_SCHEDULE = 'stepLR'
