...
if __name__ == '__main__':
    ...
    if cfg.ENVIRONMENT.DATA_BASE_DIR is not None:
        ...
        # For unlabel data
        cfg.DATA_PREPARE.TRAIN_UNLABEL_IMAGE_DIR = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.TRAIN_UNLABEL_DIR
        cfg.DATA_PREPARE.TRAIN_UNLABEL_SERIES_IDS_TXT = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.TRAIN_UNLABEL_SERIES_IDS_TXT
        cfg.DATA_PREPARE.DEFAULT_UNLABEL_DB = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.DEFAULT_TRAIN_DB
        #
